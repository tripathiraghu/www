...
<body style="background-color:#0080f0; color: white;" >

	<div class="row" style="width: 100%; margin-top: 20px; margin-left: 10px;">
		<div class="col-2">
			</div>
		<div class="col-2">
	...
	<form style="margin:0px; " type="post" action="creditEntry.php">
		...
		<button type="submit" class="btn btn-light btn-lg btn-block" style="margin-top: 20px;" >Submit</button>
	</form>
</div>
