...
<div class="container">
	<!-- form details -->
<form method="post" action="enteryconnect.php" name="fr1" enctype="multipart/form-data">
  ...
  <button  type="submit" class="btn " style="width:100%; background-color:#73f1ff; margin-top:10px;" value="Upload Image" name="submit" >Submit</button>
